...
const Banner = () => {
  ...
  return (
    <div className='flex bg-orange-500 rounded-lg px-6 sm:px-10 md:px-14 lg:px-12 my-20 md:mx-10'>
      {/* {left part} */}
      ...
      <img className='w-full h-[23rem] absolute bottom-0 right-0 max-w-md' src={assets.appointment_img}/>
